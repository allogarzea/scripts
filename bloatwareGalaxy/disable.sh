...
# ONLY UN-COMMENT THE ABOVE LINE IF YOU HAVE AN ALTERNATIVE KEYBOARD INSTALLED
...
# Not Known
adb shell pm disable-user --user 0 com.samsung.android.service.peoplestripesamsungpassautofill && 
# Samsung Visit In
...
adb shell pm disable-user --user 0 com.samsung.andorid.fmm && 
# Vision AR Apps
